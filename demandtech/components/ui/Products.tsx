    ...
    const caseStudies = [
        {
            id: 1,
            quote:
                "Empower your workforce with a modern HRMS that simplifies employee management, payroll, leave tracking, and performance monitoring. ",
            name: "Aarav Mehta",
            ...
            icon: Monitor,
            metrics: [
                { value: "50%", label: "Faster Onboarding", sub: "Streamlined recruitment and employee lifecycle" },
                { value: "99%", label: "Compliance Accuracy", sub: "Automated policy adherence and payroll management" },
            ],
        },
        {
            id: 2,
            quote:
                "Boost your outbound and inbound calling with an intelligent cloud-based dialer. Features include auto-dialing, call recording, real-time analytics, and CRM integration. ",
            name: "Sophia Patel",
            ...
            metrics: [
                { value: "85%", label: "Agent Productivity", sub: "Real-time monitoring and smart routing" },
                { value: "70%", label: "Improved Call Handling", sub: "Automated dialing" },
            ],
        },
        // {
        //     id: 3,
                            ...
                            >
                                ...
                                >
                                    <img
                                        ...
                                        className={[
                                            "aspect-[29/35] h-auto w-full rounded-2xl object-cover overflow-hidden hover:scale-105 transition-all duration-300",
                                            // Wider image (width only) for second product
                                            isSecond ? "max-w-none md:w-[22rem] lg:w-[26rem] xl:w-[30rem]" : "max-w-60",
                                        ].join(" ")}
                                        loading="lazy"
                                        decoding="async"
                                    />
