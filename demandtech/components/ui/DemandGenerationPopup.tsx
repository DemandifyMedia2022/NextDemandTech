        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-2 sm:p-4 md:p-6">
          ...
          >
            ...
            <div className="relative h-16 flex items-start justify-end p-4">
              ...
              <button
                onClick={onClose}
                className="w-8 h-8 bg-white/90 hover:bg-white rounded-full flex items-center justify-center text-gray-600 hover:text-gray-800 transition-colors shadow-lg"
