...
import { generateBlogStructuredData, generateBreadcrumbStructuredData } from '@/lib/seo'
...
export default function BlogsClient() {
    ...
    const breadcrumbStructuredData = generateBreadcrumbStructuredData([
        ...
        { name: 'Blog', url: 'https://demand-tech.com/about/blogs' }
    ]);

    const blogListStructuredData = {
        '@context': 'https://schema.org',
        '@type': 'Blog',
        name: 'DemandTech Blog',
        description: 'B2B marketing insights, lead generation strategies, and demand generation expertise',
        ...
        blogPost: posts.slice(0, 10).map(post => ({
            ...
            url: `https://demand-tech.com/about/blogs/${post.slug.current}`,
